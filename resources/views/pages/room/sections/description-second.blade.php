...
<x-section class="bg-bgThird 2xl:pt-40 lg:pb-20 ">
    ...
    <div class="xl:col-start-1 xl:col-end-5 xl:mt-24  flex flex-col items-start gap-4 mb-10 xl:mb-0 mr-0 sm:mr-20 md:mr-56 xl:mr-0">
        ...
        <h2 class="heading">Pięć pokojowych światów w Tatry Grand Hotel czeka na odkrycie</h2>
                ...
                <div class="xl:col-start-7 xl:col-end-13 rounded-lg min-h-[500px] xl:min-h-[1000px] w-full object-cover pl-0 sm:pl-20 md:pl-40 xl:pl-0">

                    <img src="{{asset('assets/images/5.jpeg')}}" alt="wnętrze hotelu" class="rounded-lg h-full w-full object-cover"></img>
                </div>


                <div class="xl:col-start-1 xl:col-end-7  rounded-lg min-h-[500px] xl:min-h-[1000px] w-full object-cover mt-20 lg:-mt-[300px] pr-0 sm:pr-20 md:pr-40 xl:pr-12">
