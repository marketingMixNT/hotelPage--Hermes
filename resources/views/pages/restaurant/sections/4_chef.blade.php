<x-sections.standard sectionClasses="bg-bgFourth pb-20 xl:pb-40">
    ...
    {{-- left side --}}
    <div
        class="xl:col-start-1 xl:col-end-6   flex flex-col items-start gap-4 mb-10 xl:mb-0 mr-0 sm:mr-20 md:mr-56 xl:mr-0  justify-between">
        <h2 class="heading heading--black">Nasz Szef Kuchni</h2>

        <div class="flex flex-col gap-12">
            <div class="space-y-2">

                <h3 class="heading heading--black heading--big">Piotr Nowosielski</h3>
            ...
            <div class="space-y-6 xl:ml-16">
                ...
                <p class="text text--black ">
                    ...
                    detalu, co sprawia, że jego kuchnia to niezapomniane doznanie dla każdego smakosza.
                </p>
            </div>
        </div>
    </div>
    ...
    {{-- right side --}}
    <div
        class="xl:col-start-7 xl:col-end-13 rounded-lg min-h-[500px] xl:min-h-[1000px] xl:max-h-[1000px] w-full object-cover">

        <img src="{{ asset('assets/images/restaurant/3.jpeg') }}" alt="wnętrze hotelu"
