<section class="px-10 xl:px-20 2xl:px-40  bg-bgPrimary">
    <x-grid>
      ...
      <div class="xl:col-start-1 xl:col-end-7  sm:pr-20 md:pr-64 xl:pr-0 max-h-[500px] md:max-h-[800px] xl:max-h-[1000px] mb-10 sm:mb-20 xl:mb-0 xl:mr-32">

        <img src="{{ asset('assets/images/6.jpeg') }}" alt="danie w naszej restauracji"
        class=" rounded-lg  w-full h-full object-cover"></img>
        <div class="mt-2 ml-2">
            <span class="text-xs uppercase font-secondary text-fontPrimary font-semibold">Danie degustacyjne:</span>
            <span class="text-xs  font-secondary text-fontPrimary tracking-wider ml-2 font-light">Marynowany Łosoś, Awokado, Krem Balsamiczny, Migdały</span>

        </div>
      </div>


        <div class="xl:col-start-9 xl:col-end-13 flex flex-col  items-start gap-8  sm:pl-20 md:pl-64 xl:pl-0 mb-10 sm:mb-20 xl:mb-0">
        ...
        <div class=" sm:pr-20 md:pr-64 xl:pr-0 xl:col-start-7 xl:col-end-13 min-h-[500px] md:min-h-[600px] xl:-mt-[100px]  3xl:-mt-[400px]">
          ...
          class=" rounded-lg  w-full h-full object-cover "></img>
          <div class="mt-2 ml-2">
            <span class="text-xs uppercase font-secondary text-fontPrimary font-semibold">Danie Główne:</span>
            <span class="text-xs  font-secondary text-fontPrimary tracking-wider ml-2 font-light">Polędwica Wołowa, Borowiki, Puree Chrzanowe, Pieczona Cykoria</span>
...
<section class="px-10 xl:px-20 2xl:px-40 pt-20 xl:pt-0 pb-20 xl:pb-40 bg-bgPrimary">
    <x-grid>
        ...
        {{-- <div class="xl:col-start-7 xl:col-end-13 xl:mt-32  flex flex-col gap-4 ">
