<x-section class="bg-bgPrimary pb-40  ">
        ...
        <div class="col-start-1 col-end-3 flex flex-col justify-between">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text">Ludźmierska 26a</p>
                    <p class="text">34-400 Nowy Targ</p>
                    <p class="text">Polska</p>
                </div>
                <div>

                    <a href="" class="link-dotted ">Facebook</a>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex flex-col">
                    <span class="font-primary font-semibold md:font-normal  text-fontPrimary text-2xl   leading-snug tracking-wide uppercase">86 km</span>
                    <span class="text">Kraków</span>
                    <span class="text">90 min</span>
                </div>
                <div class="flex flex-col">
                    <span class="font-primary font-semibold md:font-normal  text-fontPrimary text-2xl   leading-snug tracking-wide uppercase">23.6 km</span>
