<section
    ...
    bg-[url('/public/assets/images/hero2.jpeg')] 
    ...
    <div class="">
        <p class="xs:text-xl md:text-2xl xl:text-3xl text-fontWhite font-light font-text leading-normal tracking-wide"> <span
            ...
            Tatry Grand Hotel, położony w sercu polskich gór, oferuje niezapomniane widoki na górskie szczyty i zielone
            doliny, zapewniając idealne warunki do relaksu w harmonii z naturą.</p>
    </div>
</section>
